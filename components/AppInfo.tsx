...
export default function AppInfo() {
  ...
  return (
    <div className="mt-[48px] lg:mt-[64px] bg-[#f8f8f8] rounded-[16px] p-[24px] md:p-[32px] lg:p-[40px] flex flex-col items-center justify-center">
      <h2 className="mb-[4px] md:mb-[24px] lg:mb-[32px] text-[16px] md:text-[20px] lg:text-[32px] leading-[22.4px] md:leading-[34px]">
