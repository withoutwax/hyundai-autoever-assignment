          ...
          return (
            <Accordion.Item key={uuid} value={uuid}>
              <Accordion.Header className="relative group">
                <Accordion.Trigger
                  className="border-b border-[#e6e8e9] w-full flex flex-col lg:flex-row items-start lg:items-center justify-center lg:justify-start pl-[0px] lg:px-[16px] text-midnight font-semibold text-[20px] py-[16px] lg:py-[24px] 
          ...
          "
                >
                  <div className="flex flex-row lg:flex-col items-center lg:items-start">
                    <em className="lg:w-[208px] not-italic text-center lg:px-[24px] text-[#697278] font-normal text-[12px] md:text-[16px] lg:text-[20px] mb-[4px] lg:mb-0">
                      {faq.category}
                    </em>
                    {faq.subCategory && (
                      <em
                        className="lg:w-[208px] not-italic text-center lg:px-[24px] text-[#697278] font-normal text-[12px] md:text-[16px] lg:text-[20px] mb-[4px] lg:mb-0 flex items-center
                  ...
                  <strong className="flex-1 text-left mr-[57.6px] lg:mr-[88px] text-[16px] lg:text-[20px]">
                    {faq.question}
                  </strong>
                </Accordion.Trigger>
              </Accordion.Header>
